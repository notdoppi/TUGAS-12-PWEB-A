...
$sql->bindParam(':id', $id);
$execute = $sql->execute(); // Jalankan query
...
if($execute){ // Cek jika proses simpan ke database sukses atau tidak
    ...
    echo "<br><br><a href='form_ubah.php'>Kembali Ke Form</a>";
}
}else{ // Jika user memilih file foto / mengganti input file foto pada form
// Lakukan proses update dengan mengganti foto sebelumnya
$fotoharu = date('dmYHis').$foto; // Rename nama fotonya dengan menambahkan tanggal dan jam upload

// Set path folder tempat menyimpan fotonya
$path = "images/".$fotoharu;
...
if(move_uploaded_file($tmp, $path)){ // Cek apakah gambar berhasil diupload atau tidak
    ...
    if(is_file("images/".$data['foto'])) // Jika foto ada
        unlink("images/".$data['foto']); // Hapus foto sebelumnya yang ada di folder images
